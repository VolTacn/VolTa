...
int64 nChainStartTime = 1537402698;
...
const string strMessageMagic = "VolTa Signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
    ...
    if(nHeight == 1)                                                             
	{
        nSubsidy = 45000000.32 * COIN;
	}

	else if(nHeight > 1 && nHeight <= 45708334)
    {
        nSubsidy = 0.96 * COIN;
	}
	
	else if(nHeight > 45708334 && nHeight <= 90000000)
    {
        nSubsidy = 0 * COIN;
	}
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in VolTa
    bool fStrictPayToScriptHash = true; // Always active in VolTa
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "VolTa", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "CBigNum vector VolTa empty mapBlockIndex VolTa VolTa";
        CTransaction txNew;
       ...
       // printf("block.nNonce = %u \n", block.nNonce);
		block.print();
        assert(block.hashMerkleRoot == uint256("0x4b719927214d27beda355d2deedf2392730b74e390acd379cbde5021fdddea02"));
